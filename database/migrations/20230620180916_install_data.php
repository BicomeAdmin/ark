    ...
    public function config(): void
    {
        ...
        $rows  = [
            ...
            [
                ...
                'type'  => 'array',
                'value' => '[{"key":"數據回收規則配置","value":"/admin/security/dataRecycle"},{"key":"敏感數據規則配置","value":"/admin/security/sensitiveData"}]',
            ],
        ];
    ...
    public function securitySensitiveData(): void
    {
        ...
        $rows  = [
            [
                ...
                'data_table'    => 'admin',
                'primary_key'   => 'id',
                'data_fields'   => '{"username":"用戶名","mobile":"手機","password":"密碼","status":"狀態"}',
                'status'        => '1',
                'updatetime'    => $this->nowTime,
                'createtime'    => $this->nowTime,
            ],
            [
                ...
                'data_table'    => 'user',
                'primary_key'   => 'id',
                'data_fields'   => '{"username":"用戶名","mobile":"手機號","password":"密碼","status":"狀態","email":"郵箱地址"}',
                'status'        => '1',
                'updatetime'    => $this->nowTime,
                'createtime'    => $this->nowTime,
            ],

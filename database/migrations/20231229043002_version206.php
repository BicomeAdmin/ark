...
class Version206 extends Migrator
{
    ...
    public function up(): void
    {
        ...
        if (!$crudLog->hasColumn('connection')) {
            $crudLog->addColumn('connection', 'string', ['limit' => 100, 'default' => '', 'comment' => '數據庫連接配置標識', 'null' => false, 'after' => 'status']);
            $crudLog->save();
        }

        $securityDataRecycle = $this->table('security_data_recycle');
        if (!$securityDataRecycle->hasColumn('connection')) {
            $securityDataRecycle->addColumn('connection', 'string', ['limit' => 100, 'default' => '', 'comment' => '數據庫連接配置標識', 'null' => false, 'after' => 'data_table']);
        ...
        if (!$securityDataRecycleLog->hasColumn('connection')) {
            $securityDataRecycleLog->addColumn('connection', 'string', ['limit' => 100, 'default' => '', 'comment' => '數據庫連接配置標識', 'null' => false, 'after' => 'data_table']);
        ...
        if (!$securitySensitiveData->hasColumn('connection')) {
            $securitySensitiveData->addColumn('connection', 'string', ['limit' => 100, 'default' => '', 'comment' => '數據庫連接配置標識', 'null' => false, 'after' => 'data_table']);
        ...
        if (!$securitySensitiveDataLog->hasColumn('connection')) {
            $securitySensitiveDataLog->addColumn('connection', 'string', ['limit' => 100, 'default' => '', 'comment' => '數據庫連接配置標識', 'null' => false, 'after' => 'data_table']);

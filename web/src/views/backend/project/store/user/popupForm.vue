...
const rules: Partial<Record<string, FormItemRule[]>> = reactive({
    create_time: [buildValidatorData({ name: 'date', title: t('project.store.user.create_time') })],
    update_time: [buildValidatorData({ name: 'date', title: t('project.store.user.update_time') })],
})
</script>

<template>
    <div class="default-main ba-table-box">
        ...
        <TableHeader
            ...
            :quick-search-placeholder="t('Quick search placeholder', { fields: t('project.user.quick Search Fields') })"
        ></TableHeader>
...
const baTable = new baTableClass(
    new baTableApi('/admin/project.User/'),
    {
        pk: 'id',
        column: [
